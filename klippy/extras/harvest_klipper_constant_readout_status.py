        ...
        try:
            for i in messages:
                try:
                    ...
                    result = f"{klipper_object['take_snapshot_in']} {klipper_object['last_move_data']['start_move_time']} {klipper_object['last_move_data']['move_duration']} {klipper_object['snapshot_queue']}"
